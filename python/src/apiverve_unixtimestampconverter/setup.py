...
setup(
    ...
    project_urls={
        ...
        'Documentation': 'https://docs.apiverve.com/ref/unixtimestamp',
        'Source': 'https://github.com/apiverve/unixtimestamp-api',
        'Bug Tracker': 'https://github.com/apiverve/unixtimestamp-api/issues'
    },
    classifiers=[
