...
class TestUnixtimestampAPIClient(unittest.TestCase):

    def setUp(self):
        self.api_key = 'test_api_key'
        self.client = UnixtimestampAPIClient(self.api_key)

    @patch('apiverve_unixtimestampconverter.apiClient.requests.get')
