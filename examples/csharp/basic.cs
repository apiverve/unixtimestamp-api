...
{
    class UnixTimestampConverterExample
    {
        private static readonly string API_KEY = Environment.GetEnvironmentVariable("APIVERVE_API_KEY") ?? "YOUR_API_KEY_HERE";
        private static readonly string API_URL = "https://api.apiverve.com/v1/unixtimestamp";

        /// <summary>
        /// Make a GET request to the Unix Timestamp Converter API
        /// </summary>
        static async Task<JsonDocument> CallUnixTimestampConverterAPI()
        {
            try
            {
                ...
                // Query parameters
                var queryParams &#x3D; new Dictionary&lt;string, string&gt; { [&quot;timestamp&quot;] &#x3D; &quot;1609459200&quot;, [&quot;format&quot;] &#x3D; &quot;seconds&quot; };
        ...
        {
            Console.WriteLine("📤 Calling Unix Timestamp Converter API...\n");

            var result = await CallUnixTimestampConverterAPI();
