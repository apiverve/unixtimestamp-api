...
const (
	baseURL        = "https://api.apiverve.com/v1/unixtimestamp"
	defaultTimeout = 30 * time.Second
)

// Client is the Unix Timestamp Converter API client.
type Client struct {
	apiKey     string
	httpClient *resty.Client
}

// NewClient creates a new Unix Timestamp Converter API client.
...
// Execute makes a request to the Unix Timestamp Converter API with typed parameters.
//
