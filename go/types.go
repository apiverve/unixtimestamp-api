// Package unixtimestamp provides a Go client for the Unix Timestamp Converter API.
//
// For more information, visit: https://apiverve.com/marketplace/unixtimestamp?utm_source=go&utm_medium=readme
...
// Request contains the parameters for the Unix Timestamp Converter API.
//
// Parameters:
//   - timestamp (required): string - Unix timestamp to convert
...
// ResponseData contains the data returned by the Unix Timestamp Converter API.
type ResponseData struct {
	Timestamp int `json:"timestamp"`
	TimestampFormat string `json:"timestamp_format"`
	Iso_8601 string `json:"iso_8601"`
	Rfc_2822 string `json:"rfc_2822"`
	Date string `json:"date"`
	Time string `json:"time"`
	UnixSeconds int `json:"unix_seconds"`
	UnixMilliseconds int `json:"unix_milliseconds"`
	Year int `json:"year"`
