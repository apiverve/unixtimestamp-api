...
namespace APIVerve.API.UnixTimestampConverter
{
    ...
    /// <summary>
    /// Client for the UnixTimestampConverter API
    /// </summary>
    public class UnixTimestampConverterAPIClient
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        : IDisposable
#endif
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/unixtimestamp";
        ...
        public UnixTimestampConverterAPIClient(string apiKey)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public UnixTimestampConverterAPIClient(string apiKey, bool isSecure, bool isDebug)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public UnixTimestampConverterAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, UnixTimestampConverterQueryOptions options = null)
        {
            if (callback == null)
            {
        ...
        private void ValidateParams(UnixTimestampConverterQueryOptions options)
        {
        ...
        public ResponseObj Execute(UnixTimestampConverterQueryOptions options = null)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(UnixTimestampConverterQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(UnixTimestampConverterQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(UnixTimestampConverterQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(UnixTimestampConverterQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(UnixTimestampConverterQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
        ...
        /// </summary>
        private string ConstructURL(UnixTimestampConverterQueryOptions options)
        {
