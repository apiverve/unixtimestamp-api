# Unix Timestamp Converter Android SDK
...
```gradle
dependencies {
    implementation 'com.github.apiverve:unixtimestamp-api:1.1.12'
}
```
...
UnixTimestampConverterAPIClient client = new UnixTimestampConverterAPIClient("YOUR_API_KEY");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/unixtimestamp](https://docs.apiverve.com/ref/unixtimestamp)
...
- **Documentation:** [https://docs.apiverve.com/ref/unixtimestamp](https://docs.apiverve.com/ref/unixtimestamp)
- **Issues:** [GitHub Issues](https://github.com/apiverve/unixtimestamp-api/issues)
